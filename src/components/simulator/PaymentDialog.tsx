 ...
 * details are impossible to miss.
 */
  ...
  return (
    <Dialog open={open} onOpenChange={(next) => { if (!next) onClose(); }}>
      <DialogContent className="max-h-[92vh] overflow-y-auto p-0 sm:max-w-xl">
        <div className="sticky top-0 z-10 flex items-center justify-between gap-3 bg-gradient-primary px-6 py-4 text-primary-foreground sm:px-8">
